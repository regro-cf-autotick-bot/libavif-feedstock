...
pixi add _libavif_api libavif libavif16
# for installing globally
pixi global install _libavif_api libavif libavif16
```
...
It is possible to list all of the versions of `_libavif_api` available on your platform:
...
```
pixi search _libavif_api --channel conda-forge
```
